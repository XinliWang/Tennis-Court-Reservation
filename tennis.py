...
logging.basicConfig(filename='tennis.log',level=logging.DEBUG,format='%(asctime)s %(levelname)s %(message)s')
...
def runReserve():
	...
	if weekno < 5:
		...
		t = threading.Thread(target=reserve, args=(tomorrow, 10, '5:00 PM', '6:00 PM'))
		thread_list.append(t)
		t = threading.Thread(target=reserve, args=(tomorrow, 12, '4:00 PM', '5:00 PM'))
		thread_list.append(t)
